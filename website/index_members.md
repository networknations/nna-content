...
- name: Patricia Parkinson
  image: https://gobulfvwqcpyitvadxdo.supabase.co/storage/v1/object/public/application-photos/1776440451076-dogrjo9f.png
...
- name: Stefan Morales
  ...
  bio: Founder of Working Together Consulting, delegate at OpenCivics. Specializes in organizational development, social design, facilitation, and public engagement, supporting people and projects striving to build a regenerative future.
  role: Steward
  links:
    - platform: LinkedIn
...
- name: Johannes Bennke
  image: https://gobulfvwqcpyitvadxdo.supabase.co/storage/v1/object/public/application-photos/1778085721835-0ul77x5p.jpg
  bio: "Johannes Bennke is head of the Media Lab for Digital Sovereignty at Filmuniversity Babelsberg Konrad Wolf and Principal Investigator of \"The Art of Digital Sovereignty\" & \"Protocol Studies\" (Media Studies, Philosophy, Aesthetics, Artistic Research)."
  links:
    - platform: Website
      url: https://johannesbennke.info/
    - platform: LinkedIn
      url: https://de.linkedin.com/in/johannes-bennke

- name: Philip Rosedale
  bio: "Working on numerous projects related to helping people improve trust, create alternative currencies, and form communities."
  links:
    - platform: Website
      url: http://secondlife.com
    - platform: LinkedIn
      url: http://linkedin.com/in/philiprosedale

- name: Niccolo Milanese
  bio: "Director of European Alternatives, promoting Democracy Equality and Culture Beyond the Nation State; Scientific Director Berggruen Institute Europe"
  links:
    - platform: Website
...
- name: AIM States
  image: https://gobulfvwqcpyitvadxdo.supabase.co/storage/v1/object/public/application-photos/1778669062666-j16o1fhk.png
  bio: "Aim States lets anyone create and join internet communities that govern themselves - with a constitution, a shared fund, and decisions made by their own choice of governance system."
  links:
    - platform: Website
      url: https://aimstates.com
    - platform: LinkedIn
      url: https://www.linkedin.com/in/4samad/
