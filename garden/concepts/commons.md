...
The commons model also underpins [[concepts/functional-sovereignty|functional sovereignty]]. By collectively owning and managing essential infrastructure, communities reduce dependence on external authorities and build genuine operational autonomy. This is further enabled by [[concepts/networked-technologies|networked technologies]] that provide the tools for collective management at scale.
...
- [[concepts/mutualization|Mutualization]] — The practice of pooling resources as commons
- [[concepts/functional-sovereignty|Functional Sovereignty]] — Autonomy built on commons-based infrastructure
- [[concepts/self-governance|Self-Governance]] — Governing the commons collectively
