...
This principle is foundational to the concept of [[concepts/network-nations|Network Nations]] as interdependent translocal communities. These communities are geographically distributed yet highly aligned, coordinating across digital and physical spaces through interlinked nodes of people and places across different localities, bound by a shared sense of kinship.

Translocalism rejects the false binary between rootedness and mobility. A member of a translocal community can be deeply embedded in their local context while simultaneously contributing to and drawing strength from a global network. This is enabled by [[concepts/networked-technologies|networked technologies]] and sustained through [[concepts/collective-identity|collective identity]].

## Related Concepts

- [[concepts/polycentrism|Polycentrism]] — Multiple centres of decision-making across localities
- [[concepts/interdependence|Interdependence]] — The entanglement that binds translocal nodes
